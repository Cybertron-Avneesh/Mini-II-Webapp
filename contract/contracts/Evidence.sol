...
// DONE
    function createFir(string memory Title,string memory Description, uint256 time, uint256 stationid) public{
...
// DONE
    function getAllFirs() public view returns(Fir[] memory){
        ...
        //     firs_array.push(Fir(Firs[i].Title,Firs[i].Description,Firs[i].time,Firs[i].stationid,Firs[i].creator,Firs[i].evidences_arr));
        // }
        // return firs_array;
